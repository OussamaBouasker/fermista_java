...
public class NavbarController {
    ...
    private void handleReclamations(ActionEvent event) {
        navigateTo("/ReclamationsPage.fxml"); // À toi de mettre le bon chemin
    }
    ...
    @FXML
    private void handleRendezVous(ActionEvent actionEvent) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/ListVet.fxml"));
            Parent root = loader.load();
            Stage stage = (Stage) ((Node) actionEvent.getSource()).getScene().getWindow();
            stage.setScene(new Scene(root));
            stage.show();
            ...
            e.printStackTrace();
            System.err.println("Erreur lors du chargement de ListVet.fxml: " + e.getMessage());
        }
    }
    ...
    public void handleListeRendezVous(ActionEvent actionEvent) {
        try {
            ...
            e.printStackTrace();
            System.err.println("Erreur lors du chargement de ListRendezVous.fxml: " + e.getMessage());
        }
    }
}
