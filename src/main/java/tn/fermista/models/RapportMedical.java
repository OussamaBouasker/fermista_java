    ...
    public class RapportMedical {
        ...
        public RapportMedical(int num, String race, String historiqueDeMaladie, String casMedical, String solution) {
            this.num = num;
            this.race = race;
            this.historiqueDeMaladie = historiqueDeMaladie;
            this.casMedical = casMedical;
        ...
        public boolean equals(Object o) {
            ...
            return id == that.id && num == that.num && Objects.equals(race, that.race) && Objects.equals(historiqueDeMaladie, that.historiqueDeMaladie) && Objects.equals(casMedical, that.casMedical) && Objects.equals(solution, that.solution) && Objects.equals(consultation, that.consultation);
        }

        @Override
        public int hashCode() {
            return Objects.hash(id, num, race, historiqueDeMaladie, casMedical, solution, consultation);
        }
